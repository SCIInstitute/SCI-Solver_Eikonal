...
template <class T>
static inline const T vMv(const Vec<3,T> &v1, float M[], const Vec<3,T> &v2)
{
	float result = (v1[0]*M[0]+v1[1]*M[1]+v1[2]*M[2])*v2[0] + (v1[0]*M[1]+v1[1]*M[3]+v1[2]*M[4])*v2[1] + (v1[0]*M[2]+v1[1]*M[4]+v1[2]*M[5])*v2[2];
	return result;
}
